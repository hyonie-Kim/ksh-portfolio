  ...
  caseStudies: [
    {
      ...
      improvements: [
        ...
        '주요 콘텐츠를 운영팀이 직접 관리할 수 있는 CMS 구축',
      ...
      keyImplementations: [
        ...
        '병원소개·의료진 소개·메가배너·FAQ 페이지 및 관리자 CMS를 구축하여 콘텐츠 등록·수정·삭제(CRUD) 기능 구현',
    ...
    },
    {
      ...
      keyImplementations: [
        ...
        '상담 폼 제출 시 reCAPTCHA 토큰 검증 및 비정상 요청 차단',
      ],
      results: [
        '운영팀이 개발자 도움 없이 콘텐츠와 상담 신청을 직접 관리할 수 있는 CMS 확보',
        '권한별 관리자 기능 분리로 콘텐츠 관리의 안정성과 운영 보안 강화',
        '검색 유입 경로와 키워드를 관리자에서 확인할 수 있어 콘텐츠 운영 및 SEO 의사결정 지원',
        '상담 신청·콘텐츠 운영 프로세스 효율화',
        '반복적인 스팸 상담 접수를 줄여 정상 문의 확인 및 대응 업무 개선',
