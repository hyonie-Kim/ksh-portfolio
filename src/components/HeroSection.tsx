      ...
      <div className="flex flex-col text-center items-center justify-center my-10 py-16 sm:py-14 md:py-16 md:flex-row md:space-x-4 md:text-left">
        ...
        <div className="md:mt-0 md:w-3/5">
          ...
          <p className="text-lg mt-4 mb-6 md:text-lg md:leading-8">
            ...
            <br></br>
            <br></br>
            헬스케어 스타트업에서 프론트엔드로 개발자로 커리어를 시작했고, 기획자·디자이너·백엔드 개발자와의 협업을 통해 실무 이해도를 넓혔습니다.
            현재는 통신·렌탈 분야 중견기업에서 ASP.NET, Next.js, NextJS 그리고 
            Windows Server 기반의 MSSQL DB 운영 및 쿼리 최적화까지 웹 서비스 전반을 담당하고 있습니다.
            <br/>
            개발은 도구 일뿐, 업무의 구조와 흐름을 이해하며 그 안에서 개발이 유기적으로 연결되는 과정에 호기심과 재미를 느낍니다. 
            배운것을 끝내지 않고 실무에 적용하며, 함께 성장하는 개발자가 되는 것을 목표로 하고 있습니다.
          </p>
